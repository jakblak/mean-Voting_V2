...
gulp.task('copy:libs', function (done) {
    sequence('clean', 'copy:vendor', 'copy:rxjs', 'copy:angular', 'copy:bootstrap', 'copy:font-awesome', done);
});
...
gulp.task('copy:font-awesome', function() {
    return gulp
                   .src([nodeModulesPath + '/font-awesome/**/*'])
                   .pipe(gulp.dest(libPath + '/font-awesome'));
});
